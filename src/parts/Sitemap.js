    ...
    <div className="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
      <h5 className="text-lg font-semibold mb-2 relative">
        ...
        <button
          ...
          className={"absolute block md:hidden right-0 transform -translate-y-1 focus:outline-none transition duration-200 top-1/2 ".concat(
      ...
      <ul
        className={"md:h-auto md:visible md:opacity-100 overflow-hidden transition duration-200 ".concat(
